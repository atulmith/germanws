...
function selectFind(tablename,searchparam,res){
    
    mongodbconnect.mymongofunc(function(err,db){
...
// Create New Record
function create(tablename,objtosave,res){
...
// Update by ID
function update(tablename,objtosave,pkid,res){
...
//Select By ID
function selectedit(tablename,pkid,res){
...
function deleterow(tablename,pkid,res){
